...
FlatKeyboard.prototype={
    ...
    noteOn: function(note, ch) {
        console.log("[Set noteOn Eventhandler] ch:"+ch+" note:"+note);
    },
    noteOff: function(note, ch) {
        console.log("[Set noteOff Eventhandler] ch:"+ch+" note:"+note);
    },
